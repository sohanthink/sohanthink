...
const PortfolioDetails = ({ params }) => {
    ...
    const tabs = [
        ...
        if (tab.id === 'technology' && (!portfolio.details?.technologyStack || portfolio.details.technologyStack.length === 0)) return false;
                    ...
                    <div className="lg:col-span-3 space-y-5">
                        ...
                        <AnimatePresence mode="wait">
                            ...
                            >
                                        ...
                                        {portfolio.details?.developmentInsights && (
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                <div className="bg-[#0a0a0a] p-4 rounded-lg border border-grayColor/10">
                                                    <h4 className="text-lg font-sspro text-white mb-2 flex items-center gap-2">
                                ...
                                {/* Technology Tab */}
                                {activeTab === 'technology' && portfolio.details?.technologyStack && portfolio.details.technologyStack.length > 0 && (
                                    <div>
                                        <h3 className="text-2xl font-sspro text-white mb-6">Technology Stack</h3>
                                        <div className="bg-[#0a0a0a] p-6 rounded-lg border border-grayColor/10">
                                            <ul className="space-y-3">
                                                {portfolio.details.technologyStack.map((tech, index) => (
                                                    <motion.li
                                                        key={index}
                                                        initial={{ opacity: 0, x: -20 }}
                                                        animate={{ opacity: 1, x: 0 }}
